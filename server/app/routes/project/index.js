...
router.get('/', function(req, res) {
    db.query(`SELECT project_id, project_name, u2.email as project_leader,members,tables,project_status,due_date FROM projects 
